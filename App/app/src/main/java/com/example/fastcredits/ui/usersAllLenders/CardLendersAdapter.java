...
public class CardLendersAdapter extends RecyclerView.Adapter<CardLendersAdapter.RecyclerViewHolder> {
    ...
    @NonNull
    @Override
    public CardLendersAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Inflate Layout
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_layout, parent, false);
        return new CardLendersAdapter.RecyclerViewHolder(view);
    }
